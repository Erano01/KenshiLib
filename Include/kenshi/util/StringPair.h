...
public:
    ...
    StringPair* _CONSTRUCTOR(const std::string& a, const std::string& b);// public RVA = 0xAC0A0
    StringPair(const StringPair& a);// public RVA = 0x229790
    StringPair* _CONSTRUCTOR(const StringPair& a);// public RVA = 0x229790
    StringPair(const std::string& a);// public RVA = 0xAC790
    StringPair* _CONSTRUCTOR(const std::string& a);// public RVA = 0xAC790
    StringPair();// public RVA = 0xAC710
    StringPair* _CONSTRUCTOR();// public RVA = 0xAC710
