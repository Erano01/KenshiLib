...
public:
    ...
    {
    public:
        MeshLoadData(const ResourceLoader::MeshLoadData& __that);// public RVA = 0x458310
        MeshLoadData* _CONSTRUCTOR(const ResourceLoader::MeshLoadData& __that);// public RVA = 0x458310
        ...
        static ResourceLoader::MeshLoadData DEFAULT; // RVA = 0x1D8FD20 Static Member
    ...
    public:
        ...
        ResourceLoadRequestMesh(unsigned __int64 requestId, const boost::function<void __cdecl(Ogre::SharedPtr<Ogre::Resource>, void*)>& callback, Ogre::Entity* entity, const ResourceLoader::MeshLoadData& data);// public RVA = 0x449110
        ResourceLoadRequestMesh* _CONSTRUCTOR(unsigned __int64 requestId, const boost::function<void __cdecl(Ogre::SharedPtr<Ogre::Resource>, void*)>& callback, Ogre::Entity* entity, const ResourceLoader::MeshLoadData& data);// public RVA = 0x449110
    ...
    Ogre::Entity* loadModelEntity(const std::string& meshName, Ogre::SceneNode* sceneNode, bool backgroundLoading, const ResourceLoader::MeshLoadData& data, const boost::function<void __cdecl(Ogre::SharedPtr<Ogre::Resource>, void*)>& callback, Ogre::SceneMemoryMgrTypes memType, const std::string& group);// public RVA = 0x4496E0
    Ogre::Entity* loadModelEntityDetached(const std::string& meshName, bool backgroundLoading, const ResourceLoader::MeshLoadData& data, const boost::function<void __cdecl(Ogre::SharedPtr<Ogre::Resource>, void*)>& callback, Ogre::SceneMemoryMgrTypes memType, const std::string& group);// public RVA = 0x449950
    ...
    public:
        ...
        virtual void loadImage();// public RVA = 0x448210 vtable offset = 0x0
        void _NV_loadImage();// public RVA = 0x448210 vtable offset = 0x0
        virtual Ogre::SharedPtr<Ogre::Texture> getTexture();// public RVA = 0x4487E0 vtable offset = 0x0
    ...
    Ogre::Entity* createLoadRequestMesh(const Ogre::SharedPtr<Ogre::Mesh>& mesh, const boost::function<void __cdecl(Ogre::SharedPtr<Ogre::Resource>, void*)>& callback, const ResourceLoader::MeshLoadData& data, Ogre::SceneMemoryMgrTypes memType);// protected RVA = 0x449240
    virtual void operationCompleted(unsigned __int64 ticket, const Ogre::BackgroundProcessResult& result);// protected RVA = 0x44A5F0 vtable offset = 0x0
    ...
    virtual unsigned long threadProc();// protected RVA = 0x447BE0 vtable offset = 0x0
    ...
    static void SetMeshData(Ogre::Entity* entity, const ResourceLoader::MeshLoadData& data);// protected RVA = 0x447470
