...
public:
	...
	virtual int getLevel() const;// public RVA = 0xD3180 vtable offset = 0x0
	int _NV_getLevel() const;// public RVA = 0xD3180 vtable offset = 0x0
	virtual Faction* isAFactionUniform();// public RVA = 0xD3190 vtable offset = 0x0
	Faction* _NV_isAFactionUniform();// public RVA = 0xD3190 vtable offset = 0x0
	Faction* isUniform; // 0x1E8 Member
	int value; // 0x1F0 Member
	virtual GameData* _serialise(GameDataContainer* container, itemType type);// public RVA = 0x7609F0 vtable offset = 0x0
	GameData* _NV__serialise(GameDataContainer* container, itemType type);// public RVA = 0x7609F0 vtable offset = 0x0
	virtual void _loadFromSerialise(GameDataContainer* container, GameData* state);// public RVA = 0x760B70 vtable offset = 0x0
	void _NV__loadFromSerialise(GameDataContainer* container, GameData* state);// public RVA = 0x760B70 vtable offset = 0x0
	virtual void setInventoryWeAreIn(const hand& h);// public RVA = 0xD31A0 vtable offset = 0x0
...
public:
	...
	virtual float getItemWeight() const;// public RVA = 0x8A3AE0 vtable offset = 0x0
	float _NV_getItemWeight() const;// public RVA = 0x8A3AE0 vtable offset = 0x0
	virtual int getValueSingle(bool isPlayer) const;// public RVA = 0x8A3B40 vtable offset = 0x0
	...
	virtual float getCraftTime();// public RVA = 0x2B7240 vtable offset = 0x0
	float _NV_getCraftTime();// public RVA = 0x2B7240 vtable offset = 0x0
	virtual float getCraftMaterialMult();// public RVA = 0x8A8740 vtable offset = 0x0
	float _NV_getCraftMaterialMult();// public RVA = 0x8A8740 vtable offset = 0x0
	virtual void getTooltipData1(Ogre::vector<StringPair>::type& _a1) = 0;// public vtable offset = 0x0 missing arg names
	virtual Weapon* isWeapon();// public RVA = 0x8A3AF0 vtable offset = 0x0
	...
	virtual Crossbow* isCrossbow();// public RVA = 0x8A3B10 vtable offset = 0x0
...
public:
	...
	virtual void getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7B17C0 vtable offset = 0x0
	void _NV_getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7B17C0 vtable offset = 0x0
	virtual void getTooltipData2(Ogre::vector<StringPair>::type& lines);// public RVA = 0x79EC20 vtable offset = 0x0
	...
	virtual int getSkillModIndoors() const;// public RVA = 0x8A88C0 vtable offset = 0x0
...
public:
	...
	virtual float getCraftMaterialMult();// public RVA = 0x8A89F0 vtable offset = 0x0
	float _NV_getCraftMaterialMult();// public RVA = 0x8A89F0 vtable offset = 0x0
	virtual float getCraftTime();// public RVA = 0x2B8C70 vtable offset = 0x0
	...
	virtual void getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7AF4F0 vtable offset = 0x0
	void _NV_getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7AF4F0 vtable offset = 0x0
	virtual void getTooltipData2(Ogre::vector<StringPair>::type& lines);// public RVA = 0x79E920 vtable offset = 0x0
	void _NV_getTooltipData2(Ogre::vector<StringPair>::type& lines);// public RVA = 0x79E920 vtable offset = 0x0
	virtual void createItemEntityCallback_Equipping(Ogre::Entity* ent, Ogre::SceneNode* node);// public RVA = 0x43C090 vtable offset = 0x0
	void _NV_createItemEntityCallback_Equipping(Ogre::Entity* ent, Ogre::SceneNode* node);// public RVA = 0x43C090 vtable offset = 0x0
	virtual void destroyItemEntityCallback_Equipping();// public RVA = 0x434B70 vtable offset = 0x0
	void _NV_destroyItemEntityCallback_Equipping();// public RVA = 0x434B70 vtable offset = 0x0
	GunClass* gunClass; // 0x240 Member
	virtual void setVisible(bool on);// public RVA = 0x4346B0 vtable offset = 0x0
...
public:
	// Gear offset = 0x0, length = 0x228
	virtual itemType getClassType() const;// public RVA = 0x8A8430 vtable offset = 0x0
	itemType _NV_getClassType() const;// public RVA = 0x8A8430 vtable offset = 0x0
	virtual Armour* isArmour();// public RVA = 0x8A8440 vtable offset = 0x0
	Armour* _NV_isArmour();// public RVA = 0x8A8440 vtable offset = 0x0
	virtual float getItemWeight() const;// public RVA = 0x8A8450 vtable offset = 0x0
	float _NV_getItemWeight() const;// public RVA = 0x8A8450 vtable offset = 0x0
	virtual int getValueSingle(bool isPlayer) const;// public RVA = 0x8A8470 vtable offset = 0x0
	int _NV_getValueSingle(bool isPlayer) const;// public RVA = 0x8A8470 vtable offset = 0x0
	virtual void getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7A03F0 vtable offset = 0x0
	void _NV_getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7A03F0 vtable offset = 0x0
	virtual void getTooltipData2(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7A2140 vtable offset = 0x0
	...
	virtual float getCraftTime();// public RVA = 0x8A8460 vtable offset = 0x0
...
public:
	...
	virtual LockedArmour* isLockedArmour();// public RVA = 0x8A85A0 vtable offset = 0x0
	LockedArmour* _NV_isLockedArmour();// public RVA = 0x8A85A0 vtable offset = 0x0
	DoorLock* lock; // 0x2F0 Member
	virtual GameData* _serialise(GameDataContainer* container, itemType type);// public RVA = 0x760C90 vtable offset = 0x0
	GameData* _NV__serialise(GameDataContainer* container, itemType type);// public RVA = 0x760C90 vtable offset = 0x0
	virtual void _loadFromSerialise(GameDataContainer* container, GameData* state);// public RVA = 0x760D40 vtable offset = 0x0
	void _NV__loadFromSerialise(GameDataContainer* container, GameData* state);// public RVA = 0x760D40 vtable offset = 0x0
	virtual void getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7A3C60 vtable offset = 0x0
	void _NV_getTooltipData1(Ogre::vector<StringPair>::type& lines);// public RVA = 0x7A3C60 vtable offset = 0x0
	virtual void getTooltipData2(Ogre::vector<StringPair>::type& lines);// public RVA = 0x8A85B0 vtable offset = 0x0
